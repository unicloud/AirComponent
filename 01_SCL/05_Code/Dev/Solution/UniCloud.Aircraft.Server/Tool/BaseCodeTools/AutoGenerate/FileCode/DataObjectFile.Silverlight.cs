...
{
    public class DataObjectFileSilverlight : BaseFileCode
    {

        protected override string GetFilePath()
        {
            return "E:\\AutoGenerate\\DataObjects\\Silverlight\\";
        }
        ...
        {
            return new DataObjectClassSilverlight();
        }
