...
{
    public class ServiceContractInterfaceFile : BaseFileCode
    {

        protected override string GetFilePath()
        {
            return "E:\\AutoGenerate\\IServiceContracts\\";
        }
        ...
        {
            return new ServiceContractInterface();
        }
        ...
        protected override void AddHeaderUsing(Type m, StringBuilder sb)
        {
            ...
            sb.AppendLine(@"using UniCloud.Infrastructure;");
            sb.AppendLine(@"using UniCloud.Infrastructure.Caching;");
        ...
        {
            sb.AppendLine(@"namespace UniCloud.ServiceContracts");
            sb.AppendLine(@"{");
        }
