...
{
    public class ConfigurationFileOracle : BaseFileCode
    {

        protected override string GetFilePath()
        {
            return "E:\\AutoGenerate\\Configurations\\Oracle\\";
        }
        ...
        {
            return new ConfigurationClassOracle();
        }
        ...
        {
            sb.AppendLine(@"namespace UniCloud.Domain.Repositories.EntityFramework.ModelConfigurations.Oracle");
            sb.AppendLine(@"{");
        }
