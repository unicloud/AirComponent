...
{
   public class GuidProperty:  BaseProperty
    {
       public GuidProperty(string typeName)
           : base(typeName)
        {
       ...
       {
           sb.AppendLine(GeneratorHelper.GetTabString(3) + "Property(p => p." + p.Name + ").HasColumnType(\"uniqueidentifier\");");
       }
       ...
       {
           sb.AppendLine(GeneratorHelper.GetTabString(3) + "Property(p => p." + p.Name + ").HasColumnName(\"" + GetOracleColumnName(p.Name) + "\").HasColumnType(\"GUID\");");
       }
    }
}
