...
namespace BaseCodeTools.AutoGenerate.PropertyCode
{
   public class XmlProperty:  BaseProperty
    {
       public XmlProperty(string typeName)
           : base(typeName)
        {
       ...
       {
           sb.AppendLine(GeneratorHelper.GetTabString(3) + "Property(p => p." + p.Name + ").HasColumnType(\"xml\");");
       }
       ...
       {
           sb.AppendLine(GeneratorHelper.GetTabString(3) + "Property(p => p." + p.Name + ").HasColumnType(\"nvarchar\");");
       }
    }
}
