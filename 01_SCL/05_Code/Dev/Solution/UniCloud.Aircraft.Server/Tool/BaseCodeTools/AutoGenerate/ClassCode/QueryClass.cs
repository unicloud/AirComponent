...
namespace BaseCodeTools.AutoGenerate.ClassCode
{
    public class QueryClass : BaseClassCode
    {
        ...
        protected override void AddClassContent(Type m, StringBuilder sb)
        {
            ...
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"public " + m.Name + "DataObjectList Get" + m.Name + "s(" +
                          "ColumnFilterDescriptorCollection colFilter,ColumnSortDescriptorCollection sortFilter)");
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"{");
            ...
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"");
            //private method
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"#region Common Get");
            ...
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"");
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"/// <summary>");
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"/// 通过" + m.Name + "下拉数据集合");
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"/// </summary>");
            ...
            sb.AppendLine(GeneratorHelper.GetTabString(2)+"{");
            sb.AppendLine(GeneratorHelper.GetTabString(3) + "var results=new KeyValueDataObjectList();");
            sb.AppendLine(GeneratorHelper.GetTabString(3) +
                         @"var queryResult = (_context." + m.Name + "s.Select(t => new KeyValueDataObject()");
            sb.AppendLine(GeneratorHelper.GetTabString(4) +
                          @"{");
            sb.AppendLine(GeneratorHelper.GetTabString(4) + @"})).ToList();");
            sb.AppendLine(GeneratorHelper.GetTabString(3) + @"queryResult.ForEach(results.Add);");
            sb.AppendLine(GeneratorHelper.GetTabString(3) + @"return results;");
            sb.AppendLine(GeneratorHelper.GetTabString(2) + "}");
            sb.AppendLine(GeneratorHelper.GetTabString(2) + @"#endregion");
            sb.AppendLine();
        }
