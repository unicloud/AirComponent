...
namespace BaseCodeTools
{
    ...
    {
        private const string ModelAssemblyFileName = @"..\..\..\..\Domain\UniCloud.Domain.AcConfiguration\bin\Debug\UniCloud.Domain.AcConfiguration.dll";
        private const string DataObjectAssemblyFileName = @"..\..\..\..\Application\UniCloud.DataObjects.AcConfiguration\bin\Debug\UniCloud.DataObjects.AcConfiguration.dll";

        public const string ModelFilePath = @"..\..\..\..\Domain\UniCloud.Domain.AcConfiguration\Model\";
