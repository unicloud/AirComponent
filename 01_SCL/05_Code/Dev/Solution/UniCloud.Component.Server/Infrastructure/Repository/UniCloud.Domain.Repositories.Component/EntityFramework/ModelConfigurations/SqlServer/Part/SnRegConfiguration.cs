...
namespace UniCloud.Domain.Repositories.EntityFramework.ModelConfigurations.SqlServer
{
    public class SnRegConfiguration : EntityTypeConfiguration<SnReg>
    {
        public SnRegConfiguration()
        {
            ...
            Property(s => s.InstallDate).HasColumnName("INSTALL_DATE").HasColumnType("datetime2");
            ...
            Property(s => s.RemoveDate).HasColumnName("REMOVE_DATE").HasColumnType("datetime2");
            Property(s => s.RepairDate).HasColumnName("REPAIR_DATE").HasColumnType("datetime2");
            ...
            Property(s => s.Interval).HasColumnName("INTERVAL").HasMaxLength(10);
            ...
            Ignore(s => s.PnClass);
            Ignore(s => s.RootPnClass);
            Ignore(s => s.snHistory);
            Ignore(s => s.TrainRate);
            Ignore(s => s.ccHistory);
