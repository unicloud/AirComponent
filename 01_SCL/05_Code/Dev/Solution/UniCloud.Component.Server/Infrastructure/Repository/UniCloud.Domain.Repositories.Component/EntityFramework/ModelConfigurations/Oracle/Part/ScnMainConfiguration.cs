...
namespace UniCloud.Domain.Repositories.EntityFramework.ModelConfigurations.Oracle
{
    public class ScnMainConfiguration : EntityTypeConfiguration<ScnMain>
    {
        public ScnMainConfiguration()
        {
            ...
            Property(p => p.AcTypeGuid).HasColumnName("AC_TYPE_GUID").HasColumnType("GUID");
            Property(p => p.AcModelID).HasColumnName("AC_MODELID");
            Property(p => p.AcModelGuid).HasColumnName("AC_MODEL_GUID").HasColumnType("GUID");
            ...
            Property(p => p.ColseTime).HasColumnName("CLOSETIME");
