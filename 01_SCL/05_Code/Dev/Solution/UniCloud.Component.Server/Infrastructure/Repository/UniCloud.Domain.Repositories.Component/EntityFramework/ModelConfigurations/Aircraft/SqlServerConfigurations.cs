...
namespace UniCloud.Domain.Repositories.EntityFramework.ModelConfigurations.Aircraft
{
    public class SqlServerConfigurations : IModelConfigurations
    {
        ...
        {
            string encryptConnectionString = ConfigurationManager.ConnectionStrings["AircraftSql"].ToString();
        ...
        {
            modelBuilder.Configurations.Add(new AtaConfiguration());
        }
    }
}
