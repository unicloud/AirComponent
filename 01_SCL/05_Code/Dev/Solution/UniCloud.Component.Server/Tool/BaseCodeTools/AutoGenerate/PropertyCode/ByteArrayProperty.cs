...
{
   public class ByteArrayProperty:  BaseProperty
    {
       public ByteArrayProperty(string typeName)
           : base(typeName)
        {
       ...
       {
           sb.AppendLine(GeneratorHelper.GetTabString(3) + "Property(p => p." + p.Name + ").HasColumnType(\"varbinary\");");
       }
