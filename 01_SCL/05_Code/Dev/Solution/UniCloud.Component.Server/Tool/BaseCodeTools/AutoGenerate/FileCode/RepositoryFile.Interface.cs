...
{
    public class RepositoryInterfaceFile : BaseFileCode
    {

        protected override string GetFilePath()
        {
            return "E:\\AutoGenerate\\IRepositorys\\";
        }
        ...
        {
            sb.AppendLine(@"namespace UniCloud.Domain.Repositories" + "." + SubPath);
            sb.AppendLine(@"{");
        }
